package com.xworkz.collectionexample.task_05_01;
...
import com.xworkz.collectionexample.task_05_01.weaponapp.WeaponDTO;
...
public class WeaponDTOTester {
	...
	public static void main(String[] args) {
		...
		WeaponDTO weapon5 = new WeaponDTO("M16A4", "US", LocalDate.of(2003, 5, 19), 232320, Type.AssaultRifeles);
		...
		WeaponDTO weapon8 = new WeaponDTO("Groza", "India", LocalDate.of(2003, 7, 30), 101200, Type.AssaultRifeles);
		WeaponDTO weapon9 = new WeaponDTO("AUG A3", "Japan", LocalDate.of(2010, 3, 21), 123100, Type.AssaultRifeles);
		WeaponDTO weapon10 = new WeaponDTO("M762", "UK", LocalDate.of(2002, 11, 10), 1322300, Type.AssaultRifeles);
		...
		WeaponDTO weapon17 = new WeaponDTO("R1895", "Japan", LocalDate.of(1992, 5, 10), 10000, Type.Pistols);
		WeaponDTO weapon18 = new WeaponDTO("P92", "UK", LocalDate.of(1990, 3, 12), 20000, Type.Pistols);
